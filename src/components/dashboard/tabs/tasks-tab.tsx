...
import { ClipboardCheck, RotateCcw, CalendarDays, FileText, ListChecks, Lightbulb, Lock, ArrowLeft, CheckCircle2, Info, Check } from 'lucide-react';
...
const CompletionView = ({setActiveTab}: {setActiveTab: (tab: string) => void}) => {
                ...
                <div className="pt-6 border-t border-dashed text-center">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 rounded-lg border bg-secondary flex flex-col items-center">
                            ...
                            <Button variant="outline" onClick={() => setActiveTab('dashboard')} className="w-full mt-auto">
                                Back to Dashboard
                            </Button>
                        </div>
                     </div>
