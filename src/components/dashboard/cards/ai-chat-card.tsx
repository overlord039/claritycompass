  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Card className="h-[260px] flex flex-col shadow-lg cursor-pointer hover:bg-accent transition-colors group">
          <CardHeader>
          ...
          <CardContent className="flex-grow flex flex-col items-center justify-center text-center">
            ...
            <p className="text-muted-foreground mt-4 font-medium">Click to start chatting</p>
          </CardContent>
        </Card>
      </DialogTrigger>
      <DialogContent className="max-w-md h-[80vh] flex flex-col p-0">
        <DialogHeader className="p-6 pb-2">
            ...
            <DialogDescription>
                Your personal guide for your study abroad journey.
            </DialogDescription>
        </DialogHeader>
